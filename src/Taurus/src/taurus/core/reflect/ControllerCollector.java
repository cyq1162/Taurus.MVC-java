...
public class ControllerCollector {
	...
	private static void addController(String className) {
		try {
			...
			if ((super1 != null && super1.getName().equals("taurus.core.Controller"))
					|| (super2 != null && super2.getName().equals("taurus.core.Controller"))
					|| (super3 != null && super3.getName().equals("taurus.core.Controller"))) {
